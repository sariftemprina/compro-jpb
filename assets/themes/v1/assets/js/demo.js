...
new Promise((resolve, reject) => {
  const settings = {
    ...
    layout: window.localStorage.getItem('layout') || 'double-header',
    fluid: window.localStorage.getItem('builderFluidSwitch') || true,
    sidebarNavOptions: window.localStorage.getItem('sidebarNavOptions') || 'null',
  }
